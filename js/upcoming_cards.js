...
function mostrarTarjetas(eventos, currentDate) {
  ...
  eventos.forEach((evento) => {
    ...
    // Compara la fecha del evento con la "currentDate" de la API
...
fetch(apiUrl)
  ...
  .then((data) => {
    // Llamar a la función mostrarTarjetas con los datos obtenidos y la "currentDate" de la API
    mostrarTarjetas(data.events, data.currentDate);
  })
  .catch((error) => {
