...
const tarjetasContainer1 = document.getElementById("tarjetas-container");

for (const evento of data1.events) {
  const eventDate = new Date(evento.date);
  const currentDate = new Date(data1.currentDate);
  ...
  if (eventDate < currentDate) {
    ...
    tarjetasContainer1.appendChild(tarjeta);
  }
}